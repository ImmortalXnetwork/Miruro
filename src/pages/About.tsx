...
const sections = [
  {
    title: 'About',
    title2: "What's Anime State?",
    content: (
      <Paragraph>
        Anime State is an anime streaming site where you can watch anime online in HD
    ...
    content: (
      <>
        ...
        <Paragraph>
          ...
          Anime State works seamlessly on both{' '}
...
function About() {
  useEffect(() => {
    ...
    document.title = 'About | Anime State'; // Set the title when the component mounts
    return () => {

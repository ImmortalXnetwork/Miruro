...
const sections = [
  {
    ...
    content: (
      <Paragraph>
        ...
        for the functioning of Anime State, such as account information and user
        preferences.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <strong>Cookies and Tracking</strong>: Anime State uses cookies and similar
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        <strong>Acceptance of Terms</strong>: By using Anime State, you agree to
        these Terms of Service and acknowledge that they affect your legal
        rights and obligations.
        <br></br>
        <br></br>
        <strong>Content</strong>: Anime State does not host video content but embeds
        ...
        of the embedded videos remain with their respective owners. Anime State
...
function PolicyTerms() {
  useEffect(() => {
    ...
    document.title = 'Policy & Terms | Anime State'; // Set the title when the component mounts
    return () => {
